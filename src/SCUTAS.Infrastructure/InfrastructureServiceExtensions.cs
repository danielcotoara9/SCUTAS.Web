using SCUTAS.Core.Interfaces;
using SCUTAS.Core.Services;
using SCUTAS.Infrastructure.Data;
using SCUTAS.Infrastructure.Data.Queries;
using SCUTAS.UseCases.Contributors.List;

namespace SCUTAS.Infrastructure;
