using SCUTAS.Web.Core.Interfaces;
using SCUTAS.Web.Core.Services;
using SCUTAS.Web.Infrastructure.Data;
using SCUTAS.Web.Infrastructure.Data.Queries;
using SCUTAS.Web.UseCases.Contributors.List;

namespace SCUTAS.Web.Infrastructure;
