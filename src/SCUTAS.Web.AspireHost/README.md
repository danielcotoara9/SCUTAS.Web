...
1. Set `SCUTAS.Web.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../SCUTAS.Web.Infrastructure/SCUTAS.Web.Infrastructure.csproj -s SCUTAS.Web.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../SCUTAS.Web.Infrastructure/SCUTAS.Web.Infrastructure.csproj -s SCUTAS.Web.Web.csproj
```
