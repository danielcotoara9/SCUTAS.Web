...
using MinimalSCUTAS.Web.Infrastructure.Data;
using MinimalSCUTAS.Web.Infrastructure.Data.Queries;
using MinimalSCUTAS.Web.ProductFeatures.List;
using Microsoft.EntityFrameworkCore;

namespace MinimalSCUTAS.Web.Infrastructure;
