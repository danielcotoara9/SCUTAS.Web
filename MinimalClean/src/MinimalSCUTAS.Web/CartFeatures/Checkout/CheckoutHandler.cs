...
using MinimalSCUTAS.Web.Domain.CartAggregate.Specifications;
using MinimalSCUTAS.Web.Domain.GuestUserAggregate;
using MinimalSCUTAS.Web.Domain.GuestUserAggregate.Specifications;
using MinimalSCUTAS.Web.Domain.OrderAggregate;
using MinimalSCUTAS.Web.Domain.ProductAggregate;

namespace MinimalSCUTAS.Web.CartFeatures.Checkout;
