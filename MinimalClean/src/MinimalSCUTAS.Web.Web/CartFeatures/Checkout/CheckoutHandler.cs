...
using MinimalSCUTAS.Web.Web.Domain.CartAggregate.Specifications;
using MinimalSCUTAS.Web.Web.Domain.GuestUserAggregate;
using MinimalSCUTAS.Web.Web.Domain.GuestUserAggregate.Specifications;
using MinimalSCUTAS.Web.Web.Domain.OrderAggregate;
using MinimalSCUTAS.Web.Web.Domain.ProductAggregate;

namespace MinimalSCUTAS.Web.Web.CartFeatures.Checkout;
